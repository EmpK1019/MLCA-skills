...
scripts:
  - path: scripts/extract_text.py
    purpose: Extract paragraph text from DOCX files for chat attachment reading.
  - path: scripts/accept_changes.py
    purpose: Accept tracked changes in DOCX files via LibreOffice.
  - path: scripts/comment.py
    purpose: Insert Word comments and replies into unpacked DOCX XML.
  - path: scripts/office/unpack.py
    purpose: Unpack DOCX archives for low-level XML editing.
  - path: scripts/office/pack.py
    purpose: Repack edited DOCX archives.
  - path: scripts/office/validate.py
    purpose: Validate DOCX package structure after editing.
