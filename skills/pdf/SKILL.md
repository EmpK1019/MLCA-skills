...
trigger_hints: []
allowed_tools:
  - inspect_pdf_form_fields
output_contract: {}
scripts:
  - path: scripts/extract_text.py
    purpose: Extract PDF text and simple tables for chat attachment reading.
  - path: scripts/extract_form_field_info.py
    purpose: Inspect fillable PDF form fields and their coordinates.
  - path: scripts/extract_form_structure.py
    purpose: Extract PDF form structure for complex forms.
  - path: scripts/check_fillable_fields.py
    purpose: Validate whether expected fillable fields exist.
  - path: scripts/fill_fillable_fields.py
    purpose: Fill standard PDF form fields.
  - path: scripts/fill_pdf_form_with_annotations.py
    purpose: Fill non-standard PDF forms with annotations.
  - path: scripts/convert_pdf_to_images.py
    purpose: Convert PDF pages to raster images.
  - path: scripts/create_validation_image.py
    purpose: Generate validation images for PDF form filling review.
  - path: scripts/check_bounding_boxes.py
    purpose: Verify annotation or field bounding boxes in PDFs.
tags: []
form: []
prompt_template: ''
category: contextual
