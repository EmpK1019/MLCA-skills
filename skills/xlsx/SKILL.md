...
scripts:
  - path: scripts/extract_text.py
    purpose: Extract sheet previews from Excel workbooks for chat attachment reading.
  - path: scripts/recalc.py
    purpose: Recalculate workbook formulas and summarize Excel errors.
  - path: scripts/office/unpack.py
    purpose: Unpack XLSX archives for low-level XML inspection.
  - path: scripts/office/pack.py
    purpose: Repack edited XLSX archives.
  - path: scripts/office/validate.py
    purpose: Validate XLSX package structure after editing.
  - path: scripts/office/soffice.py
    purpose: Run LibreOffice operations in a controlled environment.
tags: []
form: []
prompt_template: ''
category: contextual
